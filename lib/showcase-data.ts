...
export const showcaseEvents: PublicEvent[] = [
  ...
  { id: "22222222-2222-4222-8222-222222222222", slug: "bengaluru-community-fest", title: "Karnataka Community Fest", glyph: "ಬ", banner: grad("#241030", "#4A1E5C", "#7a2f8f"), status: "showcase", startsAt: "2026-06-28T11:30:00.000Z", endsAt: "2026-07-12T16:30:00.000Z", description: "Namma ooru, namma habba. A city-wide celebration of Karnataka street culture, photography, food and folk performance.", competitionCount: 2, isShowcase: true },
...
const competitionBase: Omit<PublicCompetition, "submissionCount" | "voteCount">[] = [
  ...
  { id: "a6666666-6666-4666-8666-666666666666", eventId: showcaseEvents[2].id, eventSlug: showcaseEvents[2].slug, eventTitle: showcaseEvents[2].title, slug: "mimicry-mania", title: "Mimicry Mania", glyph: "ಮ", banner: grad("#2a1305", "#8a4510", "#FF8A00"), status: "showcase", startsAt: "2026-08-15T13:30:00.000Z", endsAt: "2026-08-15T18:30:00.000Z", description: "Voices, characters and pure Karnataka timing on one stage.", rules: ["Five minutes maximum.", "Keep the performance community friendly."], maxEntriesPerParticipant: 1, isShowcase: true },
